...
description: API reference for the SinglyLinkedList class
---

The `LinkedList` class (also known as SinglyLinkedList) provides a singly linked list implementation where each node points to the next node.
